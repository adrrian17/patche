...
| `drizzle-local.config.ts` | Local Drizzle Studio connection to Wrangler D1 state |
...
- Local Studio discovers the latest SQLite database in Wrangler local state. Run `bun run dev` first.
